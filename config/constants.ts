...
export const USER_SETTINGS: Array<{ title: string; route: string }> = [
  { title: 'Mi cuenta', route: '/my-account' },
  { title: 'Mis cursos', route: '/' }
]
...
export const COURSE_OPTIONS: Array<{ title: string; route: string }> = [
  ...
  { title: 'Syllabus', route: '/course' },
  { title: 'Mensajes', route: '/messages' }
]
