    ...
    <>
      <Box component="main" className={styles.main}>
        ...
        <Box component="section" className={styles.mainSection}>
          ...
          >
            <Typography component="h1" variant="h4">Contáctanos</Typography>
          ...
          >
            ...
            <Box component="div">
              <Typography component="h1" variant="h5">Síguenos</Typography>
              <IconButton size="medium" color="secondary" href="#" target="_blank">
                <GitHub />
              </IconButton>
              <IconButton size="medium" color="secondary" href="#" target="_blank">
                <Facebook />
